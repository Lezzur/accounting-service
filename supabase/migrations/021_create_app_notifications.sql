...
CREATE INDEX IF NOT EXISTS idx_app_notif_unread ON app_notifications(created_at DESC) WHERE read = false;
...
DROP POLICY IF EXISTS app_notifications_insert_service ON app_notifications;
