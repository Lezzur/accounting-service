...
DROP POLICY IF EXISTS lead_activity_log_select ON lead_activity_log;
CREATE POLICY lead_activity_log_select ON lead_activity_log
  FOR SELECT USING (auth.uid() IS NOT NULL);

DROP POLICY IF EXISTS lead_activity_log_insert_service ON lead_activity_log;
...
DROP POLICY IF EXISTS client_activity_log_insert_service ON client_activity_log;
...
DROP POLICY IF EXISTS email_notifications_insert_service ON email_notifications;
CREATE POLICY email_notifications_insert_service ON email_notifications
  FOR INSERT WITH CHECK (auth.role() = 'service_role');

DROP POLICY IF EXISTS email_notifications_update_service ON email_notifications;
...
DROP POLICY IF EXISTS document_attachments_insert_service ON document_attachments;
CREATE POLICY document_attachments_insert_service ON document_attachments
  FOR INSERT WITH CHECK (auth.role() = 'service_role');

DROP POLICY IF EXISTS document_attachments_update_service ON document_attachments;
...
DROP POLICY IF EXISTS ai_corrections_select ON ai_corrections;
...
DROP POLICY IF EXISTS ai_corrections_insert_service ON ai_corrections;
...
DROP POLICY IF EXISTS deadlines_service_insert ON deadlines;
...
DROP POLICY IF EXISTS financial_reports_select ON financial_reports;
...
DROP POLICY IF EXISTS bir_form_templates_select ON bir_form_templates;
...
DROP POLICY IF EXISTS bir_form_field_mappings_select ON bir_form_field_mappings;
...
DROP POLICY IF EXISTS bir_tax_form_records_select ON bir_tax_form_records;
CREATE POLICY bir_tax_form_records_select ON bir_tax_form_records
  FOR SELECT USING (auth.uid() IS NOT NULL);

DROP POLICY IF EXISTS bir_tax_form_records_insert ON bir_tax_form_records;
CREATE POLICY bir_tax_form_records_insert ON bir_tax_form_records
  FOR INSERT WITH CHECK (auth.uid() IS NOT NULL);

DROP POLICY IF EXISTS bir_tax_form_records_update ON bir_tax_form_records;
