...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitives.Trigger
    ...
    className={cn(
      ...
      "border border-slate-200 bg-white px-3 text-sm text-slate-900",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitives.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-md py-1.5 pl-8 pr-2 text-sm text-slate-900",
      "outline-none",
      "focus:bg-teal-100 focus:text-teal-700",
