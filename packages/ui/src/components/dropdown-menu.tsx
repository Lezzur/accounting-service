...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitives.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-md px-2 py-1.5 text-sm text-slate-900",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitives.SubContent
    ...
    className={cn(
      ...
      "bg-white shadow-md border border-slate-200 p-1",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitives.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-md px-2 py-1.5 text-sm text-slate-900",
...
const DropdownMenuShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => (
  <span
    className={cn("ml-auto text-xs tracking-widest text-slate-500 opacity-60", className)}
    {...props}
  />
);
